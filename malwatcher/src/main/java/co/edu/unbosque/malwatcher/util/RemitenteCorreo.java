...
public class RemitenteCorreo {
	 ...
	 * @param username
	 */
	public static boolean sendEmail(String addressee, String username, String password) {
		prop = new Properties();
		...
		content = "<!DOCTYPE html>\r\n" + "<html lang=\"es\">\r\n" + "\r\n" + "<head>\r\n"
				...
				+ "\r\n" + "<body>\r\n" + "\r\n" + "  <div class=\"container\">\r\n" + "    <!-- Header -->\r\n"
				+ "    <div class=\"header\">\r\n" + "      <img src=\"imagen/MAL-WATCHER.png\">\r\n"
				+ "      <h1>BIENVENIDO A MAL-WATCHER!</h1>\r\n" + "    </div>\r\n" + "\r\n"
				+ "    <!-- Content -->\r\n" + "    <div class=\"content\">\r\n"
				+ "      <p>Su nombre de usuario es: <span class=\"important-text\">" + username + "</span></p>\r\n"
				+ "      <br />\r\n" + "      <p>Su contraseña es: <span class=\"important-text\">" + password
				+ "</span></p>\r\n" + "      <br />\r\n" + "      <br />\r\n" + "      <br />\r\n"
				+ "      <p>Su codigo de verificacion es: <span class=\"important-text\">[9-8-7-6]</span></p>\r\n"
				+ "      <br />\r\n" + "      <br />\r\n" + "      <br />\r\n" + "      <br />\r\n"
				+ "      <p>GRACIAS POR CONFIAR EN NOSOTROS</p>\r\n" + "\r\n" + "    </div>\r\n" + "\r\n"
				+ "    <!-- Social Icons -->\r\n" + "    <div class=\"social-icons\">\r\n"
				+ "      <p>Síguenos en nuestras plataformas:</p>\r\n"
				+ "      <a href=\"#\"><img src=\"imagen/twitterMa.png\"></a>\r\n"
				+ "      <a href=\"#\"><img src=\"imagen/instagramMa.png\"></a>\r\n"
				+ "      <a href=\"#\"><img src=\"imagen/YoutubeMa.png\"></a>\r\n"
				+ "      <a href=\"#\"><img src=\"imagen/LinkedInMa.png\"></a>\r\n" + "    </div>\r\n" + "\r\n"
				+ "    <!-- Footer -->\r\n" + "    <div class=\"footer\">\r\n"
	...
	public static void setEmailFrom(String emailFrom) {
		RemitenteCorreo.emailFrom = emailFrom;
	}
	...
	public static void setPasswordFrom(String passwordFrom) {
		RemitenteCorreo.passwordFrom = passwordFrom;
	}
	...
	public static void setSubject(String subject) {
		RemitenteCorreo.subject = subject;
	}
	...
	public static void setContent(String content) {
		RemitenteCorreo.content = content;
	}
	...
	public static void setSession(Session session) {
		RemitenteCorreo.session = session;
	}

	public static MimeMessage getEmail() {
		return email;
	}

	public static void setEmail(MimeMessage email) {
		RemitenteCorreo.email = email;
	}
